...
namespace WrightAngle.Waypoint
{
    ...
    public class WaypointUIManager : MonoBehaviour
    {
        ...
        // --- Internal State ---
        private UnityEngine.Pool.ObjectPool<WaypointMarkerUI> markerPool; // Efficiently reuses marker UI GameObjects.
        ...
        private void InitializePool()
        {
            ...
            markerPool = new UnityEngine.Pool.ObjectPool<WaypointMarkerUI>(
